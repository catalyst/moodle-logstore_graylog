...
$string['udp'] = 'GELF UDP';
$string['tcp'] = 'GELF TCP';
$string['logguestuser'] = 'Log guest users';
$string['logguestuser_desc'] = 'Should entries created by an unauthenticated client be logged?';
$string['allowevents'] = 'Allow events';
$string['allowevents_desc'] = 'Selected events will be logged, unselected events discarded';
